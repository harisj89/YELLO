...
import com.project.controller.StoresManager;
...
public class StoresAction extends ActionSupport {
    ...
    private List<Stores> restaurantsList = new ArrayList<Stores>();
    private Long res_id;
    ...
    private StoresManager restaurantsManager= new StoresManager();
	...
	public String convertAddress(){ 
    	...
    	for(Stores restaurant: restaurantsList){ 
...
//				    System.out.println("Value of Partial match is " + result.isPartial_match());
	...
	public Stores getRestaurants() {
		return restaurants;
	}

	public void setRestaurants(Stores restaurants) {
	...
	public void setRestaurantsList(List<Stores> restaurantsList) {
